...
public record SystemStatsProjection(
        @Schema(description = "Total number of created orders", example = "150")
        int totalOrders,
        @Schema(description = "Number of completed orders", example = "85")
        int completedOrders,
        @Schema(description = "Number of blocked orders", example = "3")
        int blockedOrders,
